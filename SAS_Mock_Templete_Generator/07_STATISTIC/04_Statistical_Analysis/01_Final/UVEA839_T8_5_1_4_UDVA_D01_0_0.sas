/************************************************************************************
 Programme name:   		UVEA839_T8_5_1_4_UDVA_D01_0_0.sas
 Programme language: 	SAS 9.4
 Initial date: 			28/APR/2022
 Sponsor | study: 		Carl Zeiss Meditec AG | UVEA839
 Author(s): 		 	RPA
 *************************************************************************************
 Short description: 	Table 8.5.1.4	  - Secondary endpoints
 	 	 	 	 	 	 	 	 	 	 	Visual acuity
 	 	 	 	 	 	 	 	 	 	 	Postoperative UDVA
 Requirements: 	 		---
 Risk assessment: 		Low
 ...
 *** Name of this program;
 %LET THIS_PROG= UVEA839_T8_5_1_4_UDVA_D01_0_0;
 %LET THIS_TOC_LABEL = Table 8.5.1.4;
 %LET DS_NAMES = UVEA839_T8_5_1_4;
 %LET CAPTION_LVL1 = Secondary endpoints;
 %LET CAPTION_LVL2 = Visual acuity;
 %LET CAPTION_LVL3 = Postoperative UDVA;
 ...
 *************************************************************************************;
 ...
 PROC REPORT DATA=UVEA839_T8_5_1_4_D99 HEADLINE HEADSKIP NOWD SPLIT='|' MISSING CONTENTS='';
 COLUMNS (DUMMY (
 	EMPTY_COLUMN
 ));
