...
```{r global_options, include=FALSE, echo = FALSE,message = FALSE, error = FALSE, warning = FALSE}
...
Inline LaTeX equations can be written in a pair of dollar signs using the LaTeX syntax, e.g. ${\displaystyle f_{Y}(\mathbf {y} \mid {\boldsymbol {\theta }},\tau )}$
...
```{r table, echo=FALSE, message = FALSE, error = FALSE, warning = FALSE}
...
The R extension package pander provides better table capabilities and can also work well with the knitr package for output. Its pander() function can convert a variety of R output formats into the table form required by knitr.
...
| AAAA                 | ...                  | ...              |
| AAAAA                | ...                  | ...              |
Table: \centering This is the table caption (left alignment)
...
| AAAA                 | ...                  | ...              |
| AAAAA                | ...                  | ...              |
Table: \centering This is the table caption (center alignment)
...
| AAAA                 | ...                  | ...              |
| AAAAA                | ...                  | ...              |
Table: \centering This is the table caption (right alignment)
