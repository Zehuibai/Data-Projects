...
%let Output_folder    = C:\Users\zbai\Desktop\SAS;
...
title1 j=l  height=10pt font=courier bold bcolor="#e6f3ff" "Table 1.2:^R/RTF'\tab' Results from cumulative logit model";
